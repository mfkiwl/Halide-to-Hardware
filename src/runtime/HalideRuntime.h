...
typedef enum halide_target_feature_t {
    ...
    // Halide-to-hardware specific targets
    halide_target_feature_coreir, ///< Enable output to CoreIR.
    halide_target_feature_coreir_valid, ///< Enable output signal valid for CoreIR.
    halide_target_feature_hls, ///< Enable output to HLS.
